...
pub fn get_image_of_floats(path: &str) -> Result<(Vec<f32>, (usize, usize)), Box<dyn std::error::Error>> {
    ...
    for y in 0..height {
        for x in 0..width {
            ...
            floats.push(pixel[0] as f32 / 255.) // Normalizing color
        }
    }

    Ok((floats, (width as usize, height as usize)))
}
